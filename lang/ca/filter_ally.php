...
$string['privacy:metadata:jwt:roles'] = 'Els rols de l\'usuari al curs per validar l\'accés.';
$string['privacy:metadata:jwt:userid'] = 'L\'ID d\'usuari per validar l\'accés.';
